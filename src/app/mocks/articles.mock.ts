...
export const ARTICLES: IArticles[] = [
...

        {
            ...
            text: "La Tunisie est une destination de choix pour les amateurs de culture, d'histoire et de détente. \n\n Avec ses magnifiques plages, ses sites archéologiques impressionnants et ses villes animées, la Tunisie offre une variété d'expériences pour tous les types de voyageurs. \n Des villes historiques comme Tunis et Carthage aux paysages pittoresques de Sidi Bou Said et de la ville côtière de Hammamet, il y a tant à voir et à découvrir. \n De plus, la Tunisie est également connue pour sa délicieuse cuisine, sa riche tradition artisanale et son hospitalité chaleureuse. \n\n Que vous soyez à la recherche de vacances culturelles ou de détente, la Tunisie ne manquera pas de vous séduire.",
            positivePoints: [
...

        {
            ...
            text: "Le Monténégro est un petit pays situé sur la côte Adriatique, offrant des paysages montagneux à couper le souffle et des plages de sable fin bordées d'eaux cristallines. \n\n Les villes médiévales préservées, comme Kotor et Budva, sont des joyaux culturels à ne pas manquer, tandis que le parc national de Durmitor offre des activités de plein air telles que la randonnée, le rafting et le ski en hiver. \n\n Les Monténégrins sont accueillants et fiers de leur pays, offrant une expérience de voyage authentique et inoubliable.",
            positivePoints: [
